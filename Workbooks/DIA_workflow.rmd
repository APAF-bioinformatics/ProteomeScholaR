...
installProteomeScholaR <- function(verbose = TRUE) {
    ...
    installIfMissing <- function(pkg, source = "CRAN") {
    ...
    # Load all packages
    invisible(sapply(c("ProteomeScholaR", bioc_packages)
