...
process_long_format(input_data = peptide_values_imputed_file
...
save_plot(QC_composite_figure@pca_plots$pca_plot_after_ruvIIIc_group, results_dir, "pca_plot_after_ruvIIIc")
