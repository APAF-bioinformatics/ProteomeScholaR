...
experiment_label <- "0.9_finaltest" #NB this will affect directory structure and name of your experiment downstream

setupAndShowDirectories(label = "experiment_label"
                        , force = FALSE)
```
