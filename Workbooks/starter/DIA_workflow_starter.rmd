...
experiment_label <- "" # NB this will affect directory structure and name of your experiment downstream
...
# Replace read.table with vroom for better file reading
...
search_srl_quant_cln@peptide_data |>
...
removed_proteins_with_less_than_two_peptides@peptide_data |>
  distinct(Protein.Ids) |>
  nrow()
