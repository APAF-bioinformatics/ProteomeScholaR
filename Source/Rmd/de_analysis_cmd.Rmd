...
type_of_grouping <- getTypeOfGrouping(design_matrix=design_mat_cln, group_id=my_group_id, sample_id=my_sample_id)
...
counts_rnorm.log.ruvIII_v1 <- cmriRUVfit(counts_rnorm.log.quant, X=ruv_groups$group, control_genes_index, Z = 1, k = ruv_k,
