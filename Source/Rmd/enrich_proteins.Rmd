...
# results_dir <- "/home/ignatius/PostDoc/2022/PYROXD1_BMP_13/Results/N155S/enrich_proteins"
# group_pattern <- "\\d+" 
...
## Create directories
```{r}
createDirectoryIfNotExists( results_dir)
...
gene_set_idx_list_file <- file.path(results_dir,  "gene_set_idx_list_file.RDS")
...
```{r}
    ...
    camera_results_file <- file.path(results_dir,  "camera_results.RDS")
...
vroom::vroom_write( camera_results_filt, 
                    file.path( results_dir,  "filtered_camera_results.tab"))


writexl::write_xlsx( camera_results_filt,
                     file.path(results_dir,  "filtered_camera_results.xlsx"))
