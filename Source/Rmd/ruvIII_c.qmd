...
editor: source
author: Ignatius Pang and Will Klare
---
...
parser <- add_option(parser, c("-c", "--config"), type = "character", default = "/Users/ignatiuspang/Workings/2024/e_33105_AGITG-GI_SarahHayes_20230327/config_prot.ini",
...
## Check data matrix against design matrix
```{r}

cln_dat_wide_cleaned <- evidence_tbl_filt
...
na_values_marker <- !is.na(counts_filt)
