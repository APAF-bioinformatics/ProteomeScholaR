...
output_dir <- "/home/ignatius/PostDoc/2022/PYROXD1_BMP_13/Results/N155S/de_proteins/"
...
counts_rnorm.log.quant <- vroom::vroom( file.path(output_dir, "counts_after_median_scaling_and_imputation.tsv") )
counts_rnorm.log.ruvIII <- vroom::vroom( file.path(output_dir, "normalized_counts_after_ruv.tsv")  )
...
gene_names_data <- vroom::vroom("/home/ignatius/PostDoc/2022/PYROXD1_BMP_13/Results/N155S/annot_proteins/de_proteins_long_annot.tsv") %>%
...
selected_data <- vroom::vroom( file.path(output_dir, "lfc_qval_long.tsv") )  %>%
