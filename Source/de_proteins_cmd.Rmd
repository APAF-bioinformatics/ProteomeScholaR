...
knitr::purl( file.path(  source_dir, "ALPK1",  "de_proteins_cmd.Rmd"), 
             output=file.path( source_dir,  "ALPK1",   "de_proteins_cmd.R") ) 
...
cln_dat_wide <- ProteomeRiver::remove_empty_rows( evidence_tbl_filt, col_pattern=group_pattern, row_id=!!rlang::sym(my_row_id))
