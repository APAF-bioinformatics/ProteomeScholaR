...
installProteomeScholaR <- function(verbose = TRUE) {
   ...
   # First ensure devtools is available
   ...
   if (verbose) message("ProteomeScholaR installation completed and loaded!")
}
...
DIANN_filename <- "240903_Run1_Reanalysis.tsv"
fasta_filename <- "uniprotkb_proteome_UP000189702_2024_10_29.fasta"
...
```{r}
# Commented code to read the design matrix back in later
...
```{r Enrichment Analysis 2.0 for non-model organism}
enrichment_results <- processEnrichments_v2(
   ...
   go_annotations = uniprot_dat_cln  # Replace with your actual dataframe
)
```
