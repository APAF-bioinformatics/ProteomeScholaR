...
process_fasta_file <- function(fasta_file_path, uniprot_search_results, uniparc_search_results, fasta_meta_file) {
...
match_and_update_dataframes <- function(aa_seq_tbl, uniprot_search_results, uniparc_search_results) {
...
# Usage
aa_seq_tbl_final <- match_and_update_dataframes(aa_seq_tbl, uniprot_search_results, uniparc_search_results)
...
update_protein_ids <- function(protein_data, aa_seq_tbl_final) {
...
aa_seq_tbl_final <- process_fasta_file(fasta_file_path, uniprot_search_results, uniparc_search_results, fasta_meta_file)
data_cln <- update_protein_ids(data_cln, aa_seq_tbl_final)
