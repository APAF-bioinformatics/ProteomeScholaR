...
DIANN_filename <- "DIANN_report.tsv"
fasta_filename <- "your_organism.fasta"
...
# Commented code to read the design matrix back in later
 design_matrix <- read.table(
   file = file.path(source_dir, "design_matrix.tsv"),
   sep = "\t",
   header = TRUE,
...
protein_normalized_pif_cln <-  removeRowsWithMissingValuesPercent(protein_log2_quant_cln 
                                                                ...
                                                                , max_groups_percentage_cutoff = 80
...
enrichment_results <- processEnrichments(
   ...
   go_annotations = uniprot_dat_cln # GO annotations
)
